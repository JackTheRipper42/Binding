...
namespace Assets.Test.Scripts.Binding
{
    ...
    class NotifingObjectTest
    {
        ...
        {
            const int value = 42;
            var subject = new NotifingObject<int>(value);
        ...
        {
            var value = new List();
            var subject = new NotifingObject<List>(value);
            Assert.AreEqual(value, subject.GetValue());
        }
        ...
        {
            var subject = new NotifingObject<TimeSpan>();
        ...
        {
            var subject = new NotifingObject<List>();
        ...
        public void SetValue_ValueType_PropertyChangedRaised()
        {
            ...
            var subject = new NotifingObject<int>();
